...
export default function ProfileSection({ cms }: ProfileSectionProps) {
    ...
    return (
        <>
            <section id="home" className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-20 flex flex-column justify-center md:text-start sm:py-32">
                <div className="flex flex-col lg:flex-row gap-12 items-center">
                    <div className="space-y-6 animate-fadeInUp">
                        <p className="text-sm uppercase tracking-widest text-blue-500 font-semibold">
                            {cms?.super_title}
                        </p>
                        <h1 className="text-4xl sm:text-5xl lg:text-5xl font-bold leading-tight bg-gradient-to-r from-gray-900 to-gray-600 dark:from-white dark:to-gray-400 bg-clip-text text-transparent">
                            {cms?.title}
                        </h1>
                    ...
                    {/* Image container */}
                    <div className="relative animate-fadeInUp w-72 h-72 aspect-square mx-auto md:mx-0" style={{ animationDelay: '0.2s' }}>       <div className="absolute inset-0 rounded-full overflow-hidden bg-gradient-to-r from-blue-500 to-purple-600 blur-3xl opacity-20 animate-pulse"></div>
